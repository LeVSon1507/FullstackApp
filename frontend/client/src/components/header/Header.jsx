...
const Header = ({ type }) => {
   ...
   const handleValid = () => {
      alert('Destination must be one of three locations: DaNang, SaiGon, HaNoi!!!');
   };
   ...
   return (
      <div className='header'>
         <div className={type === 'list' ? 'headerContainer listMode' : 'headerContainer'}>
            ...
            {type !== 'list' && (
               <>
                  <h1 className='headerTitle'>Welcome to LVS Booking</h1>
                  <p className='headerDesc'>
                     Unlock a World of Discounts with LVS Booking - Enjoy 10% or More Savings for a
                     Lifetime of Travels
                  </p>
                  {!user && (
                  ...
                  <div className='headerSearch'>
                     <div className='headerSearchItem'>
                        ...
                        <DropDownBox destination={destination} setDestination={setDestination} />
                     </div>
                     <div className='headerSearchItem'>
